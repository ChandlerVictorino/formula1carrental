    ...
    <div class="card-body">
        ...
        <form action="<?php echo base_url().'admin/mobile_update' ?>" method="post">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10"><input type="text" class="form-control" name="carname" value="<?php echo $m->mobile_carname; ?>"></div>
                <?php echo form_error('carname'); ?>
            </div>
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">Plate Number</label>
                <div class="col-sm-10"><input type="text" class="form-control" name="plate" value="<?php echo $m->mobile_plate; ?>"></div>
            </div>
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">Car Color</label>
                <div class="col-sm-10"><input type="text" class="form-control" name="color" value="<?php echo $m->mobile_color; ?>"></div>
            </div>
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">Vehicle Year</label>
                <div class="col-sm-10"><input type="text" class="form-control" name="year" value="<?php echo $m->mobile_year; ?>"></div>
            </div>
            <div class="form-group row">
