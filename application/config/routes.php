...
$route['superadmin/create'] = 'superadmin/create_admin';
$route['superadmin/store'] = 'superadmin/store_admin';
...
$route['api/cars']['get'] = 'CarAPI/index';                         // GET
$route['api/cars']['post'] = 'CarAPI/create';                       // POST
$route['api/cars/delete/(:num)']['delete'] = 'CarAPI/delete/$1';    
